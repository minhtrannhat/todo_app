...
from fastapi_todo.models.usermodel import UserModel
from fastapi_todo.schemas.todo_schemas import (
    TodoBaseSchema,
    TodoUpdateSchema,
    TodoResponseSchema,
)
...
def get_my_todos_view(
    ...
    current_user: UserModel = Depends(get_current_user),  # type: ignore
):
